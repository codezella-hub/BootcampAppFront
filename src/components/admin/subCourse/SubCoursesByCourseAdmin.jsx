...
export default function SubCoursesByCourseAdmin() {
                        ...
                        <div className="col-lg-9">
                            <div className="announcements-wrapper-dashed">
                                <div className="top-announcement-wrapper">
                                    ...
                                    <div className="right">
                                        <Link to={`/AddSubCourseAdmin`} type="button" className="rts-btn btn-primary">
                                            Add New SubCourse
                                        </Link>
                                    </div>
                                </div>
                                                ...
                                                ListSubCourses.map(item => (
                                                    <tr key={item._id}>
                                                        ...
                                                        <td className="announcement-1">
                                                            ...
                                                            <div className="right">
                                                                <button 
                                                                    onClick={() => navigate(`/UpdateSubCourseAdmin/${item._id}`)} 
