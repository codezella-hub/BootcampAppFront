            ...
            <div className="about-area-start rts-section-gapBottom">
                <div className="container">
                    <div className="row align-items-center">
                            ...
                            <div className="about-one-left-image">
                                        ...
                                        <div className="information">
                                            <div className="left">
                                                <h3 className="title"><span
                                                    className="counter animated fadeInDownBig">2.4</span>k</h3>
                                ...
                                <div className="second-order">
                                    ...
                                    <div className="vedio-icone">
                                        <a className="video-play-button play-video popup-video"
                        ...
                        <div
                            className="col-xl-6 col-lg-12 pl--60 pl_lg--15 pl_md--10 pl_sm--10 pt_lg--50 pt_md--50 pt_sm--50">
