                                        ...
                                        <ul className="rts-dropdown-menu switcher-language">
                                            <li className="has-child-menu">
                                                ...
                                                <ul className="sub-menu">
                                                    <li>
                                                        <a href="#">
                                                            <img className="left-image" src="assets/images/flag-03.svg" alt="Deutsch" />
                                                            <span className="menu-item">Deutsch</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <img className="left-image" src="assets/images/flag-02.svg" alt="Portuguese" />
                                                            <span className="menu-item">Portuguese</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <img className="left-image" src="assets/images/flag-04.svg" alt="Russian" />
                                                ...
                                                {isAuthenticated && (
                                                    <>
                                                        ...
                                                        {user.role === "admin" && (
                                                            <>
                                                                <li className="has-dropdown">
                                                                    <Link className="nav-link" to="/posts">Admin Page 1</Link>
                                                                </li>
                                                                <li className="has-dropdown">
                                                                    <Link className="nav-link" to="/posts">Admin Page 2</Link>
                                                                </li>
                                                            </>
                                                        )}
                                                        ...
                                                        {user.role === "professor" && (
                                                            <>
                                                                <li className="has-dropdown">
                                                                    <Link className="nav-link" to="/ListSubCourse">SubCourses</Link>
                                                                </li>
                                                                <li className="has-dropdown">
                                                                    <Link className="nav-link" to="/ListVideo">Videos</Link>
                                                                </li>
                                                                <li className="has-dropdown">
                                                        ...
                                                        <li className="has-dropdown">
                                                            ...
                                                            <ul className="submenu">
                                                                <li><Link className="nav-link" to="/homeRooms">Meeting</Link></li>
