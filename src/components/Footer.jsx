...
function Footer() {
  return (
<div>    {/* footer call to action area start */}
  <div className="footer-callto-action-area bg-light-1">
    <div className="container ptb--105">
      <div className="row">
            ...
            <div className="footer-singl-wized left-logo">
              ...
              <div className="body">
                ...
                <ul className="wrapper-list">
                  ...
                  <li><a href="call-to_61485826710.html"><i className="fa-regular fa-phone" />+(61) 485-826-710</a></li>
                </ul>
              </div>
            </div>
  ...
  {/* footer call to action area end */}</div>
